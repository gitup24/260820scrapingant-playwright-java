...
public class Main {
    static void main() {
        ...
        try {
            ...
            processor.saveToJson(processor.cleanData(data), "/home/olivier/IdeaProjects/260820scrapingant-playwright-java/src/main/java/org/example/main/scraped_data.json");
            */
        ...
        try {
            List<String> dataDynamic = dynamicScraper.scrapeDynamicContent("https://google.com", "h1");
